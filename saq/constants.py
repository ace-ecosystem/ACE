...
DISPOSITION_CSS_MAPPING = {
    ...
    DISPOSITION_APPROVED_BUSINESS: 'success',
    DISPOSITION_APPROVED_PERSONAL: 'success',
}
...
DISPOSITION_RANK = {
    ...
    DISPOSITION_APPROVED_BUSINESS: 1,
    DISPOSITION_APPROVED_PERSONAL: 2,
    DISPOSITION_UNKNOWN: 3,
    DISPOSITION_REVIEWED: 4,
    DISPOSITION_GRAYWARE: 5,
    DISPOSITION_POLICY_VIOLATION: 6,
    DISPOSITION_RECONNAISSANCE: 7,
    DISPOSITION_WEAPONIZATION: 8,
    DISPOSITION_INSIDER_DATA_CONTROL: 9,
    DISPOSITION_DELIVERY: 10,
    DISPOSITION_EXPLOITATION: 11,
    DISPOSITION_INSTALLATION: 12,
    DISPOSITION_COMMAND_AND_CONTROL: 13,
    DISPOSITION_INSIDER_DATA_EXFIL: 14,
    DISPOSITION_EXFIL: 15,
    DISPOSITION_DAMAGE: 16,
}
