...
class ExceptionFormatter(object):
    ...
    def get_traceback_information(self, tb):
        ...
        return filename, lineno, function, source, source, relevant_values


    def format_traceback_frame(self, tb):
        filename, lineno, function, source, source, relevant_values = self.get_traceback_information(tb)
    ...
    def _format_exception(self, value, tb, seen=None):
        ...
        formatted, source = self.format_traceback(exc_traceback)
