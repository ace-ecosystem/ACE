...
def get_work_queue(*args, **kwargs):
    get_system().work_queue_manager.get_work_queue(*args, **kwargs)

def invalidate_work_queue(*args, **kwargs):
    get_system().work_queue_manager.invalidate_work_queue(*args, **kwargs)

def add_work_queue(*args, **kwargs):
    get_system().work_queue_manager.add_work_queue(*args, **kwargs)
